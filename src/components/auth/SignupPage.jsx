// src/components/auth/SignupPage.jsx - FIXED VERSION
      ...
      if (result.success) {
        ...
        try {
          if (formData.accountType === 'business') {
            await emailNotificationService.sendBusinessWelcomeEmail(result.user);
          } else {
            await emailNotificationService.sendIndividualWelcomeEmail(result.user);
          }
        ...
        // FIXED: Proper redirect based on account type
        if (formData.accountType === 'business') {
          console.log('🏪 Redirecting business user to /business/post-deal');
          navigate('/business/post-deal');
        } else {
          console.log('👤 Redirecting individual user to /');
          navigate('/');
        }
      }
    } catch (error) {
